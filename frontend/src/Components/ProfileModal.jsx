...
//                   animate={{ scale: 1, y: 0 }}
//                   className="bg-gradient-to-br from-gray-900 to-black p-8 rounded-2xl border border-white/10 max-w-md w-full mx-4 shadow-2xl"
//                 >
...
//             {/* Modal content */}
//             <div className="relative h-full w-full bg-white/95 dark:bg-gray-900/95 backdrop-blur-xl rounded-2xl overflow-y-auto shadow-2xl border border-white/10 dark:border-gray-800/50">
...
//               {/* Profile content with subtle entrance animation */}
//               <motion.div
    ...
    <AnimatePresence>
      {isOpen && (
        ...
        >
          ...
          {/* Logout Confirmation Modal - Moved to root level */}
          <AnimatePresence>
            {showLogoutConfirm && (
              <motion.div
                initial={{ opacity: 0 }}
