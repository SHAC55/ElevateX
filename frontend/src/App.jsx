...
// Standard layout — sidebar + padded main
...
// Interview layout — sidebar + zero-padding, full-height main
// Prevents the interview page from being pushed down or clipped
  ...
  return (
    <>
      ...
      <Routes>
        ...
        {/* ✅ Interview uses InterviewLayout — no padding, no overflow, full height */}
        <Route
          path="/mock-interview"
          element={
            <ProtectedRoute>
