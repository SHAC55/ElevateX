...
const HomePage = () => {
  ...
  const { completedSkills, inProgressSkills, miniProjects, resumeScore, skills, projects ,goal} = dashboardData;
   console.log("Skills passed to Skillsdash:", skills);
    ...
    {goal || "Not set"}
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6 mt-6">
        {miniDash.map((item, idx) => (
          <div key={idx} className="border border-gray-200 bg-white rounded-xl p-5">
